...
final class ___VARIABLE_productName___Presenter: BasePresenter {
    ...
    var interactor: ___VARIABLE_productName___InteractorPresenterInputProtocol?
    
    var router: ___VARIABLE_productName___RouterPresenterInputProtocol?
    
    weak var delegate: ___VARIABLE_productName___OutputDelegate?
...
// MARK: - Input Delegate
extension ___VARIABLE_productName___Presenter: ___VARIABLE_productName___InputDelegate {
