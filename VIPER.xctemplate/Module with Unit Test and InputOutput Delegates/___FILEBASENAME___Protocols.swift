...
protocol ___VARIABLE_productName___ViewPresenterOutputProtocol: AnyObject {
    ...
    var delegate: ___VARIABLE_productName___OutputDelegate? { get set }
...
// MARK: - Delegates
protocol ___VARIABLE_productName___OutputDelegate: AnyObject {
    
    
}

protocol ___VARIABLE_productName___InputDelegate: AnyObject {
